...
int main()
{
    ...
    // Convertendo o PIB de bilhões para reais
    pibPerCapita1 = (pib1 * 1000000000) / (float)population1;
    ...
    printf("%d", population2);
    pibPerCapita2 = (pib2 * 1000000000) / (float)population2;
